// The head-unit certificate a phone accepts in the TLS handshake, the same one
// the main process presents.

pub const HU_CERT_PEM: &str = "-----BEGIN CERTIFICATE-----
...
pub const HU_KEY_PEM: &str = "-----BEGIN RSA PRIVATE KEY-----
