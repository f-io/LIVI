export const buildServerCgiScript = (): string =>
  [
    ...
    '  echo "<li><a href=\\"$SCRIPT_NAME?action=rbhelp\\">Discover riddleBoxCfg options</a></li>"',
    ...
    '  val="$v"',
    '  [ -z "$val" ] && val="7"',
    '  case "$val" in 0|7) ;; *) val="7" ;; esac',
    '  echo "<h1>DashboardInfo</h1>"',
    '  echo "<p>Execute <code>riddleBoxCfg -s DashboardInfo $val</code></p>"',
    '  /usr/sbin/riddleBoxCfg -s DashboardInfo "$val" >/tmp/riddle-dbi.log 2>&1',
    '',
    '  echo "<h2>/tmp/riddle-dbi.log</h2><pre>"',
    '  sed -n "1,200p" /tmp/riddle-dbi.log 2>&1',
    '  echo "</pre>"',
    '',
    '  echo "<h2>Current</h2><pre>"',
    '  /usr/sbin/riddleBoxCfg -g DashboardInfo 2>&1 | sed -n "1,60p"',
    '  echo "</pre>"',
    '',
    '  echo "<div class=\\"bar\\"><span class=\\"chip\\"><a href=\\"$SCRIPT_NAME\\">Back</a></span></div>"',
    '  footer',
    ...
    'rb_help() {',
    '  header',
    '  echo "<h1>riddleBoxCfg discovery</h1>"',
    '  nav',
    '  echo "<p class=\\"muted\\">Trying common help/list flags. Output is truncated.</p>"',
    '  echo "<pre>"',
    '',
    '  RB="/usr/sbin/riddleBoxCfg"',
    '  if [ ! -x "$RB" ]; then',
    '    RB="$(command -v riddleBoxCfg 2>/dev/null || true)"',
    '  fi',
    '',
    '  if [ -z "$RB" ] || [ ! -x "$RB" ]; then',
    '    echo "riddleBoxCfg not found."',
    '    echo "</pre>"',
    '    echo "<div class=\\"bar\\"><span class=\\"chip\\"><a href=\\"$SCRIPT_NAME\\">Back</a></span></div>"',
    '    footer',
    '    return',
