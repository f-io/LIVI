...
import { DashboardConfig } from '@renderer/components/pages/telemetry_2/config'
import { normalizeDashComponents } from '@renderer/components/pages/telemetry_2/utils'
import { DashboardsPagination } from '@renderer/components/pages/telemetry_2/components/pagination/pagination'
import { DashPlaceholder } from '@renderer/components/pages/telemetry/components/DashPlaceholder'
import { useKeyboardNavigation } from '../telemetry/hooks/useKeyboardNavigation'
import { FC, useContext, useEffect, useState } from 'react'
import { clamp } from '@renderer/utils'
import { useNavbarHidden } from '@renderer/hooks/useNavbarHidden'

export const Telemetry_: FC = () => {
  ...
  const { prev,
    ...
    canPrev,
    canNext,
    onPointerDown, onPointerUp } = useKeyboardNavigation({
    dashboards,
    isNavbarHidden,
    index,
    onSetIndex: setIndex
  ...
  return (
    ...
    >
      ...
      {dashboards.length > 1 && <DashboardsPagination
        activeIndex={index}
